...
<body>
    ...
    <% if (request.getAttribute("org.springframework.web.servlet.support.FlashMap.message") != null) { 
      String message = (String) request.getAttribute("org.springframework.web.servlet.support.FlashMap.message");
  %>
      <div class="message">
          <%= message %>
      </div>
