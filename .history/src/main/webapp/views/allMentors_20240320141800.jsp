...
<body>
    ...
    <h1>All Mentor </h1>
    <form action="searchMentor" method="GET"> <!-- Assuming 'searchMentor' is the URL pattern for handling search -->
      <label for="name">Search By Name</label>
      <input type="search" name="searchName"> <!-- Input field for entering the name to search for -->
