...
<body>
    ...
    <h1>All Mentor </h1>
    <% String deletemessage=(String)session.getAttribute("deletemessage"); if(deletemessage!=null) { %>
      ...
      %>
    <div class="container">
      <form action="/allmentors" method="GET" id="searchterm">
        <input type="text" name="searchTerm" placeholder="Enter mentor name">
